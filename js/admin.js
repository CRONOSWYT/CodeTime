document.addEventListener("DOMContentLoaded", () => {
  ...
  botonAplicarFiltroFechas.onclick = () => {
    ...
    if (finDate < inicioDate) {
      Swal.fire({ icon: "warning", title: "Error", text: "La fecha final debe ser igual o posterior a la inicial" });
      return;
    }

    const inicioDay = new Date(inicioDate.getFullYear(), inicioDate.getMonth(), inicioDate.getDate());
    const finDay = new Date(finDate.getFullYear(), finDate.getMonth(), finDate.getDate());
